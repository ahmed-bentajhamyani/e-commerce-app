        ...
        <div className={` transition-all duration-[0.25S] ${showSearch ? 'hidden' : 'block'} flex justify-end`}>
          ...
          <ul className="flex ml-3">
            <li onClick={() => setshowSearch(true)} className={`transition-all duration-[0.25S] ${isFixed ? 'pr-4 pl-4' : 'pr-6 pl-6'} h-full border-l border-gray-300 flex items-center justify-center transition ease-in duration-100 hover:bg-slate-100 cursor-pointer`}>
              <svg height={28} width={28} version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 52.966 52.966" xmlSpace="preserve">
            ...
            <li className={`transition-all duration-[0.25S] ${isFixed ? 'pr-4 pl-4' : 'pr-6 pl-6'} h-full border-l border-gray-300 flex items-center justify-center transition ease-in duration-100 hover:bg-slate-100 cursor-pointer`}>
              <div className={`${isFixed ? 'top-[9px] right-[128px]' : 'top-[160px] right-[155px]'} absolute flex items-center justify-center h-5 w-5 bg-black rounded-full text-white`}>
                <span className="text-xs">1</span>
              </div>
              <svg className="svg-icon" width={40} height={40} style={{ verticalAlign: 'middle', overflow: 'hidden' }} viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"><path d="M893.456828 709.055005" />
            ...
            <li onClick={() => setShowCart(true)} className={`transition-all duration-[0.25S] ${isFixed ? 'pr-4 pl-4' : 'pr-6 pl-6'} h-full border-l border-gray-300 flex items-center justify-center transition ease-in duration-100 hover:bg-slate-100 cursor-pointer`}>
              <div className={`${isFixed ? 'top-[9px] right-[60px]' : 'top-[160px] right-[70px]'} absolute flex items-center justify-center h-5 w-5 bg-black rounded-full text-white`}>
                <span className="text-xs">{cartQuantity}</span>
              </div>
              <svg className="svg-icon" width={40} height={40} style={{ verticalAlign: 'middle', overflow: 'hidden' }} viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg">
