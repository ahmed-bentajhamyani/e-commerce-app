...
export default function WishListPage() {
    const { wishlistProductIds, removeWishlistProductById } = useWishlistContext()
    return (
                    ...
                    wishlistProductIds.length > 0
                        ...
                        <>
                            <table className="w-full">
                                ...
                                <tbody>
                                    {
                                        wishlistProductIds.map((wishlistProductId, index) =>
                                            <WishlistRow key={index} wishlistProductId={wishlistProductId} callbackFn={() => removeWishlistProductById(wishlistProductId)} />)
                                    }
                                </tbody>
                            </table>
                        </>
